...
public class ParkingSlot implements Comparable<ParkingSlot> {
    ...
    public boolean equals(Object o) {
        ...
        return slotNumber == that.slotNumber && floorNumber == that.floorNumber;
    }

    @Override
    public int hashCode() {
        return Objects.hash(slotNumber) + Objects.hashCode(floorNumber);
    }

    @Override
    public int compareTo(ParkingSlot that) {
        return (this.slotNumber*this.floorNumber) - (that.slotNumber*that.floorNumber);
    }
}
